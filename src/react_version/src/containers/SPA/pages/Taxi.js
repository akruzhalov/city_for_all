                ...
                <Row>
                    <Col lg={12}>
                        ...
                        <div className="Taxi__info">
                            <p>
                                <b>Служба "Социальное такси"</b> может оказать услуги по перевозке и 
                                сопровождению маломобильных граждан по городу, а так же осуществить 
                                перевозку в г. Ноябрьск (платно).
                            </p>
                        </div>
                    </Col>
                </Row>
