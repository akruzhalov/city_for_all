    ...
    <div class="super_container">
            ...
            <div class="header_wrap d-flex flex-row align-items-center justify-content-center">
                ...
                <nav class="main_nav">
                    <ul class="d-flex flex-row align-items-center justify-content-center">
                        <li class="active"><a href="slabo.html">Главная</a></li>
                        <li><a href="slabo.html#vol">Волонтёры</a></li>
                        <li><a href="slabo.html#mag">Магазины</a></li>
                        <li><a href="slabo.html#apt">Аптеки</a></li>
                        <li><a href="slabo.html#tax">Такси</a></li>
                        <li><a href="slabo.html#gum">Гуманитар</a></li>
                        <li><a href="slabo.html#ub">Уборка</a></li>
                        <li><a href="slabo.html#soc">Обслуживание</a></li>
                    </ul>
                </nav>
        ...
        <header class="fixed_header">
            <div class="header_wrap d-flex flex-row align-items-center justify-content-center">
                ...
                <!-- Logo -->
                <div class="logo"><a href="slabo.html"><img src="images/logo.png" alt=""></a></div>
        ...
        <div class="menu">
            ...
            <div class="menu_content d-flex flex-column align-items-center justify-content-center">
                <div class="menu_close">Закрыть</div>
                <div class="menu_nav_container">
                    <nav class="menu_nav text-center">
                        <ul>
                            <li><a href="slabo.html">Главная</a></li>
                            <li><a href="slabo.html#vol">Волонтёры</a></li>
                            <li><a href="slabo.html#mag">Магазины</a></li>
                            <li><a href="slabo.html#apt">Аптеки</a></li>
                            <li><a href="slabo.html#tax">Такси</a></li>
        ...
        <div class="home">
            ...
            <div class="home_slider_container">
                <div class="owl-carousel owl-theme home_slider">
                    ...
                    <!-- Slide -->
                    <div class="slide">
                        <div class="background_image" style="background-image:url(images/IMG_4238.JPG.jpg)"></div>
                                        ...
                                        <div class="col">
                                            <div class="home_content active">
                                                <div class="home_title">
                                                    <h1><span>Заказ услуг няни</span></h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <h1 class="hp">Заказ няни</h1>
        <div class="section_subtitle4">Заявка принимается не позднее 1 дня по телефону:</div>
        <div class="section_subtitle2"><a href="tel:+7 (34938) 29 2 05">+7 (34938) 29-205</a></div>
        <hr style="border: 2px solid blue;">
        <div class="about" id="gh">
            <div class="container">
                <div class="row">
                    <!-- About Content -->
                            ...
                            <div class="section_title_container">
                                <form action="mail2.php" method="post">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input name="serial" id="serial" class="form-control mb-3" required type="text"
                                               placeholder="1234" style="width: 130px; height: 50px;">
                                        </div>
                                     <div class="col-md-5 d-flex">
                                        <input name="number" id="number" class="form-control mt-auto mb-3" required type="text"
                                    ...
                                    <div class="form-group form-check"
                                        ...
                                        <input id="checkbox" class="form-check-input  form-input-taxi" type="checkbox"
                                               onclick="check()">
                                        <label style="font-size: 14px; font-weight: normal; line-height: 20px" class="form-check-label" for="checkbox"
                                               title="Достоверность и полноту настоящих сведений подтверждаю. Даю согласие на обработку персональных данных о себе в соответствии со статьей 9 Федерального закона от 27 июля 2006г. № 152 - ФЗ «О персональных данных для включенияв регистр получателей социальных услуг».">Даю согласие на обработку персональных данных</label>
                                    </div>
                                    <input type='submit' id="delButton" class="btn btn-dark btn-lg contact submit2"
                                           disabled value='Отправить'
                                           style="width: 300px; height: 60px; margin-top: 10px;margin-left: 27.5%">
        ...
        <footer class="footer">
            <div class="footer_content">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="footer_logo text-center"><a href="slabo.html"><img src="images/logo2.png"
                                                                                           alt=""></a>
                            </div>
                        </div>
                    </div>
