            ...
            <div class="header_wrap d-flex flex-row align-items-center justify-content-around">
                ...
                <nav class="main_nav">
                    <ul class="d-flex flex-row align-items-center justify-content-center">
                        ...
                        <li><a href="index.html#vol">Волонтёры</a></li>
                        <li><a href="index.html#mag">Магазины</a></li>
                        <li><a href="index.html#apt">Аптеки</a></li>
                        <li><a href="index.html#tax">Такси</a></li>
                        <li><a href="index.html#gum">Гуманитар</a></li>
                        <li><a href="index.html#ub">Уборка</a></li>
                            ...
                            <div class="section_title_container">
                                <form action="mail2.php" method="post">
                                    ...
                                    <div class="form-group form-check"
                                         style="width:700px; padding-left: 0; margin-top: 10px">
